    ...
    <section className="relative h-[90vh] min-h-[700px] overflow-hidden bg-onyx">
      <div className="absolute inset-0 z-0">
        <motion.img
          ...
          src="/catalog/IMG-20260209-WA0047.jpg"
          alt="Featured footwear collage"
          ...
          <div className="lg:col-span-8 flex flex-col">
            ...
            >
              ...
              <p className="text-xl text-white/50 mb-12 leading-relaxed max-w-xl font-medium">
                SULEMAN IMPORT'S now showcases your uploaded shoe catalog with clean local listings, imported studio drops, and quick-browse flash picks.
                <span className="block mt-4 text-white/80 font-bold">Real stock. Real photos. Ready to sell.</span>
              </p>
            ...
            >
              {[
                { label: 'Listings', val: '33', color: 'text-primary-indigo' },
                { label: 'Imported', val: '24', color: 'text-heritage-amber' },
                { label: 'Local', val: '9', color: 'text-white' },
                { label: 'Flash Picks', val: '6', color: 'text-white' },
              ].map((stat, i) => (
                <div key={i}>
